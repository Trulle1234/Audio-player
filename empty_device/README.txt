...
Place MP3 files inside one of the numbered folders in the "channels" folder.

To give a channel a custom name, create a file named "name.txt" inside its
folder. Write the channel name on the first line of the file.
...
The player will use the title and artist stored in the MP3 file when available.
